...
const terms = () => {
  return (
    <TermsContainer>
      ...
      <Paragraph>
        ---- OVERVIEW This website is operated by EBLOG. Throughout the site,
        the terms “we”, “us” and “our” refer to EBLOG. EBLOG offers this
        ...
        store shall also be subject to the Terms of Service. You can review the
        most current version of the Terms of Service at any time on this page.
        We reserve the right to update, change or replace any part of these
        Terms of Service by posting updates and/or changes to our website. It is
        ...
        changes constitutes acceptance of those changes. Our store is hosted on
        Shopify Inc. They provide us with the online e-commerce platform that
      ...
      <Paragraph>
        ...
        of your minor dependents to use this site. You may not use our products
        for any illegal or unauthorized purpose nor may you, in the use of the
      ...
      <Paragraph>
        ...
        over networks. You agree not to reproduce, duplicate, copy, sell, resell
      ...
      <Paragraph>
        ...
        modify the contents of this site at any time, but we have no obligation
      ...
      <Paragraph>
        {" "}
        - MODIFICATIONS TO THE SERVICE AND PRICES Prices for our products are
      ...
      <Paragraph>
        {" "}
        - PRODUCTS OR SERVICES (if applicable) Certain products or services may
        be available exclusively online through the website. These products or
        services may have limited quantities and are subject to return or
        exchange only according to our Return Policy. We have made every effort
        to display as accurately as possible the colors and images of our
      ...
      <SubTitle>SECTION 6</SubTitle>
      <Paragraph>
        {" "}
        - ACCURACY OF BILLING AND ACCOUNT INFORMATION We reserve the right to
      ...
      <Paragraph>
        {" "}
        - OPTIONAL TOOLS We may provide you with access to third-party tools
        ...
        by the relevant third-party provider(s). We may also, in the future,
      ...
      <Paragraph>
        ...
        our Service may include materials from third-parties. Third-party links
      ...
      <Paragraph>
        ...
        postal mail, or otherwise (collectively, &apos;comments&apos;), you
      ...
      <Paragraph>
        ...
        the store is governed by our Privacy Policy. To view our Privacy Policy.
      </Paragraph>{" "}
      ...
      <Paragraph>
        ...
        law. No specified update or refresh date applied in the Service or on
      ...
      <Paragraph>
        ...
        stated by &apos;as available&apos; for your use, without any
        ...
        durability, title, and non-infringement. In no case shall EBLOG, our
      ...
      <SubTitle>SECTION 14</SubTitle>
      <Paragraph>
        {" "}
        - INDEMNIFICATION You agree to indemnify, defend and hold harmless EBLOG
      ...
      <Paragraph>
        ...
        agreement for all purposes. These Terms of Service are effective unless
        and until terminated by either you or us. You may terminate these Terms
        of Service at any time by notifying us that you no longer wish to use
        our Services, or when you cease using our site. If in our sole judgment
      ...
      <Paragraph>
        ...
        accordance with the laws of 98-30 67th ave, Rego Park, NY, 11375, United
        States.
      </Paragraph>{" "}
      <SubTitle>SECTION 19</SubTitle>
      <Paragraph>
        {" "}
        - CHANGES TO TERMS OF SERVICE You can review the most current version of
        the Terms of Service at any time at this page. We reserve the right, at
        our sole discretion, to update, change or replace any part of these
        Terms of Service by posting updates and changes to our website. It is
        your responsibility to check our website periodically for changes. Your
        continued use of or access to our website or the Service following the
        posting of any changes to these Terms of Service constitutes acceptance
        of those changes. SECTION 20 - CONTACT INFORMATION Questions about the
        Terms of Service should be sent to us at tmukhamedov97@gmail.com.
      </Paragraph>
    </TermsContainer>
  );
};
